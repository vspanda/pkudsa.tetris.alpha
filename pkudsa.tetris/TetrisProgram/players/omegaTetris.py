class Player:
    ...
    def output(self, matchData):
        ...
        for move in validMoves:
            ...
            scores.append(
                0
                + 760666 * linesFull(testBoard)
                - 356630 * (holesFound(testBoard) - self.currentHoles)
                - 510066 * sum(columnHeights)
                - 104483 * bumpiness(columnHeights)
                - 760666 * villainScore(testBoard)
            )
