...
try:
    ...
    if platform.system() == "Windows":
        if sys.version_info[1] < 7:
            ...
            exec('import CppAcceleration37 as CppAcceleration')
        elif sys.version_info[1] == 8:
            exec('import CppAcceleration38 as CppAcceleration')
        elif sys.version_info[1] == 9:
            exec('import CppAcceleration39 as CppAcceleration')
        elif sys.version_info[1] == 10:
            exec('import CppAcceleration310 as CppAcceleration')
